...
from app.routers import spells as spell_router # <--- IMPORT THE NEW SPELL ROUTER
...
app.include_router(spell_router.router, prefix=settings.API_V1_STR) # <--- INCLUDE THE SPELL ROUTER
