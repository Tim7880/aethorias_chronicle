...
async def websocket_endpoint(
    ...
    await manager.broadcast_json({"type": "user_join", "sender": "System", "payload": {"text": f"'{sender_name}' has joined the room."}}, campaign_id)
    ...
    try:
        while True:
            ...
            if msg_type == 'chat':
                ...
                current_encounter = manager.encounter_states.get(campaign_id, {"is_active": False, "order": [], "turn_index": -1})
                
                if msg_type == 'start_encounter':
                    ...
                    current_encounter = { "is_active": True, "turn_index": 0, "order": sorted_order, "active_entry_id": active_entry['id'] if active_entry else None }
