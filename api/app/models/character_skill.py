...
if TYPE_CHECKING:
    ...
    from .skill import Skill # For relationship type hinting
...
class CharacterSkill(Base):
    ...
    # has_expertise = Column(Boolean, default=False, nullable=True) # Future enhancement
    ...
    # A character should only have one entry per skill
